...
echo -e "\033[1;97m  ¿ESCRIBE UN NOMBRE?"
 msg -bar
echo -e "\033[1;96m DIGITE UN NOMBRE:\033[0;37m"; read -p " " figlet
(echo $figlet; echo $fitglet)|locat >/dev/null
sleep 1s
...
wget -O /bin/rebootnb https://raw.githubusercontent.com/DanssBot/genadminvps/master/VPS-MX/Install/ArchivosUtilitarios/rebootnb &> /dev/null
chmod +x /bin/rebootnb 
wget -O /bin/resetsshdrop https://raw.githubusercontent.com/DanssBot/genadminvps/master/VPS-MX/Install/ArchivosUtilitarios/resetsshdrop &> /dev/null
...
#echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/DanssBot/genadminvps/master/GENERADOR-VPS-MX/Install/Vercion &>/dev/null'>> .bashrc
echo 'echo ""'>> .bashrc
